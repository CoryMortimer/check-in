const newsletterTemplate = (emailsAndMessages) => {
  return `<!doctype html>
    ...
    <div style="">
      ...
      <div style="margin:0px auto;max-width:600px;">
        ...
        <![endif]-->
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:helvetica;font-size:20px;line-height:1;text-align:left;color:#000000;">Here is an update from your group.</div>
                      </td>
                    </tr>
                    ${generateBodyFromMessages(emailsAndMessages)}
                  </table>
                </div>
                <!--[if mso | IE]>
              </td>
...
const generateBodyFromMessages = (emailsAndMessages) => {
  return emailsAndMessages.reduce((accum, { email, message }) => {
    return accum + `
      <tr>
        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
          <div style="font-family:helvetica;font-size:24px;line-height:1;text-align:left;color:#000000;">Update from ${email}</div>
        </td>
      </tr>
      <tr>
        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
