    ...
    <div style="">
      ...
      <div style="margin:0px auto;max-width:600px;">
        ...
        <![endif]-->
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:helvetica;font-size:20px;line-height:1;text-align:left;color:#000000;">You are invited to join a group newsletter! Simply <span style="font-weight:bold;">reply to this email</span> to let the group know how you have been doing this past month.</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
